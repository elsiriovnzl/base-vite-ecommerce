...
import { FormData } from '../../GenericStep';
...
const StepThree = ({data, cart}: Props) => {
      ...
      return (
        <div className="h-full w-full flex gap-5 items-center">
          <div className=" flex w-full flex-col items-center justify-center gap-4">
            <div
              className={` w-[200px] h-[200px]  flex items-center justify-center hover:bg-black/30 cursor-pointer`}
            >
              <img
