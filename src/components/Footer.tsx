...
<footer
  ...
  <div className="mx-6 py-10 text-center md:text-left">
    <div className="grid-1 grid gap-8 grid-cols-4 sm:grid-cols-1 md:grid-cols-2">
      <div className="">
        ...
        <p>
        Innovación desde el corazón de Venezuela: El Sirio para tu hogar.
        </p>
      </div>
      <div>
        <h6
        ...
        <p className="mb-4">
          <a href="#!">Linea Lenceria</a>
        </p>
        <p className="mb-4">
          <a href="#!">Linea Hogar</a>
        </p>
        <p>
          <a href="#!">Linea Casa</a>
        </p>
      ...
      <div>
        ...
        <p className="mb-4">
          <a href="#!">Politicas de Despacho</a>
        </p>
        <p className="mb-4">
      ...
      <div>
        ...
        <p className="mb-4 flex items-center justify-center md:justify-start">
          ...
          elsiriovenezolano2023@gmail.com
        </p>
        <p className="mb-4 flex items-center justify-center md:justify-start">
          <span className="me-3 [&>svg]:h-5 [&>svg]:w-5">
            <svg
  ...
  <div className="bg-black/5 p-6 text-center flex justify-between">
    <div className="">
